...
interface TokenEncryptionKeyManager {
    suspend fun generateAESKeyIfNeed(keyAlias: String): Boolean
    suspend fun getCipherForEncryption(keyAlias: String): Cipher?
    suspend fun getCipherForDecryption(keyAlias: String, iv: ByteArray): Cipher?
    suspend fun encryptToken(cipher: Cipher, token: String): ByteArray?
    suspend fun decryptToken(cipher: Cipher, encryptedToken: ByteArray): String?
}

class TokenEncryptionKeyManagerImpl(
